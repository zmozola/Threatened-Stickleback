...
numeric_traits <- c("sl", "body_depth.adj", "ap_length.adj", "ap_width.adj", "jaw_length.adj", 
                    ...
                    "dorsal_3", "pelvic_spine.adj", "eye_diameter.adj", "plate_l_total", "plate_r_total")
...
#Armor/Year comparison (most common arrangements)
for (j in names(lakes)){
  lake <- lakes[[j]]
  lakecolour <- lakecolours[[j]]
  for (i in levels(lake[["year"]])){ #I know something is wrong right here but IDK what
    for(h in platearrangements) {
