...
numeric_traits <- c("sl", "body_depth.adj", "ap_length.adj", "ap_width.adj", "jaw_length.adj", "ppl.adj", "ppw.adj", "dorsal_1.adj", "dorsal_2.adj", "dorsal_3.adj", "dorsal_3", "pelvic_spine.adj", "eye_diameter.adj")

countable_traits <- c("ap_pa", "pp_pa", "dorsal_1_pa", "dorsal_2_pa", "dorsal_3_pa", "pelvic_spine_pa")

lakes <- c("drizzle", "mayer", "rouge", "boulton", "serendipity")

lakes2 <- list(drizzle, mayer, rouge, boulton, serendipity)

lakes3 <- c("Drizzle Lake", "Mayer Lake", "Serendipity Lake", "Boulton Lake", "Rouge Lake")

sexylakes <- list(drizzlesex, mayersex, rougesex, boultonsex, serendipitysex)
...
#Figure out how to loop both (yay! remember to use lakes2)
for (j in lakes2) {
  for (i in numeric_traits) {
...
#Drizzle
for (i in numeric_traits) {
    print(ggplot(drizzle, aes(x = sl, y = .data[[i]])) + geom_point(color = "chartreuse4") + geom_text(aes(label = fish_id), color = "chartreuse4"))
}

#Mayer
for (i in numeric_traits) {
    print(ggplot(mayer, aes(x = sl, y = .data[[i]])) + geom_point(color = "darkorange2") + geom_text(aes(label = fish_id), color = "darkorange2"))
}

#Serendipity
for (i in numeric_traits) {
    print(ggplot(serendipity, aes(x = sl, y = .data[[i]])) + geom_point(color = "blue") + geom_text(aes(label = fish_id), color = "blue"))
}

#Boulton
for (i in numeric_traits) {
    print(ggplot(boulton, aes(x = sl, y = .data[[i]])) + geom_point(color = "purple") + geom_text(aes(label = fish_id), color = "purple"))
}
...
for (i in numeric_traits) {
    print(ggplot(data = dataclean, aes(x = body_of_water, y = .data[[i]], color = time_period,)) +
  geom_boxplot() +
  theme_minimal() +
...
#Drizzle
for (i in numeric_traits) {
    print(ggplot(data = drizzle, aes(x = as.factor(year), y = .data[[i]], color = time_period)) +
...
#Mayer
for (i in numeric_traits) {
    print(ggplot(data = mayer, aes(x = as.factor(year), y = .data[[i]], color = time_period)) +
...
#Serendipity
for (i in numeric_traits) {
    print(ggplot(data = serendipity, aes(x = as.factor(year), y = .data[[i]], color = time_period)) +
  geom_boxplot(fill = "blue") +
  theme_minimal() +
  labs(title = "Serendipity") +
  scale_fill_discrete(name = "Year"))
}

#Boulton
for (i in numeric_traits) {
    print(ggplot(data = boulton, aes(x = as.factor(year), y = .data[[i]], color = time_period)) +
...
#Rouge
for (i in numeric_traits) {
    print(ggplot(data = rouge, aes(x = as.factor(year), y = .data[[i]], color = time_period)) +
...
#Drizzle
for (i in numeric_traits) {
    print(ggplot(data = drizzlesex, aes(x = time_period, y = .data[[i]], color = sex)) +
  geom_boxplot(fill = "chartreuse4") +
  theme_minimal() +
  labs(title = "Drizzle") +
...
#Mayer
for (i in numeric_traits) {
    print(ggplot(data = mayersex, aes(x =  time_period, y = .data[[i]], color = sex)) +
  geom_boxplot(fill = "darkorange2") +
  theme_minimal() +
  labs(title = "Mayer") +
  scale_fill_discrete(name = "Time Period"))
...
#Serendipity
for (i in numeric_traits) {
    print(ggplot(data = serendipitysex, aes(x =  time_period, y = .data[[i]], color = sex)) +
  geom_boxplot(fill = "blue") +
  theme_minimal() +
  labs(title = "Serendipity") +
  scale_fill_discrete(name = "Time Period"))
...
#Boulton
for (i in numeric_traits) {
    print(ggplot(data = boultonsex, aes(x = time_period, y = .data[[i]], color = sex)) +
  geom_boxplot(fill = "purple") +
  theme_minimal() +
  labs(title = "Boulton") +
  scale_fill_discrete(name = "Time Period"))
...
#Rouge
for (i in numeric_traits) {
    print(ggplot(data = rougesex, aes(x =  time_period, y = .data[[i]], color = sex)) +
  geom_boxplot(fill = "red") +
  theme_minimal() +
  labs(title = "Rouge") +
  scale_fill_discrete(name = "Time Period"))
...
for (j in sexylakes) {
  for (i in numeric_traits) {
    print(ggplot(data = j, aes(x =  as.factor(year), y = .data[[i]], color = sex)) +
  geom_boxplot() +
  theme_minimal() +
  labs(title = names(sexylakes[j])) +
  scale_fill_discrete(name = "Year"))
}}
